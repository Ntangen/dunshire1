...
abwoods = function(x){
	...
	monster = beasts.lev0[Math.round((Math.random()*3)+7)];
...
afaith = function(x){
	if (x===1){
		...
		if (userInfo.level <=1){
			...
			output(4, "\"But you are as yet inexperienced. Ask again when you achieve the level of Apprentice - and we will consider your worthiness for the community of The Faithful.\"<br>");
