...
abbey = function(x){
	...
	if (userInfo.xp < 102) {
		...
		if (userInfo.mission==="abbey" && missioncomplete){
			...
			output(3, "Our order will gratefully pray for your health and vitality. But in addition, please accept these most modest of tokens of our deepest thanks.<br><br>" + 
			...
			// during mission	
			output(1, "The Abbey's door hangs a single hinge. Inside, broken benches are strewn about in disarray. The altar in the front of the room is smashed.<br>");
			output(2, "The old Cleric looks up from his cleaning as you enter the room, and his eyes brighten. \"Greetings, wanderer. Our congregation cannot wait for the safe return of our precious censer... truly, you are most noble in taking on this dangerous task!\"<br>");
...
abbeyrouter = function(x){
	...
	if (CheckAbbey()){
		if (x==="q"){
			...
			clear();
			output(1, "Well...\" he begins, pausing his sweeping for a rest on one of the few benches left intact, \"as you can see, wanderer, we are but a humble village abbey here. As Cleric, I lead the people here in our observance of The Faith, as the Great Father requires.<br>");
			output(2, "The other day, this holy sanctuary was desecrated by marauders. They came in the night, stole our precious censer, and gave me quite a bump on the head in the process...<br>");
			output(3, "I see you do not wear the hood of a Keeper of our Faith. Even so, perhaps you would be willing to help catch these bandits and recover our lost censer? This Abbey would be greatly in your debt.<br>");
