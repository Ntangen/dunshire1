...
enter = function (){
		thread = 0.1;
		clear();
		output(1, "You're walking down a dirt path. Light snow crunches beneath your feet, and the nighttime chill of winter reddens your cheeks. The woods are still in the silent cold.<br><br>" +
...
enterpath = function(){
	clear();
	output(2, "As you enter, the red-cheeked Innkeeper looks up from where he's clearing a table.<br><br>" +
		"<span id=quote>\"Greetings! New news around here, stranger! The Village of Dunshire has begun some major renovations. Many things are about to change. You've been warned...\"</span><br><br>");
	output(3, "<span id=quote>\"Now that that's out of the way - what's your name?\"</span><br><br>")
	thread = 0.2;
}
					...
					if (temp===1){
						...
						Meteor.call('checkUser',u,"start",0,function(error,result){
							if (result.duel===true){
								...
								// ghost is now an array of challengers and W/L while the user was sleeping
							}
