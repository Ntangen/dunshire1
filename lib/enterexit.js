...
greeting = function (x){
	if (x==="h"){
		...
		output(1, "The Innkeeper nods his head. \"Okay then.\"<br><br>" +
			"\"This here's a waystation. A place to get started before you head down the road to the village of Dunshire.<br>" +
		...
		output(2, "Of course, you won't always have to tromp into the forest for those things. As time goes on, you're like to discover that there are more ways than one to get ahead in Dunshire...<br>")
