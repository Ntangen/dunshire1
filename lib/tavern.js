...
tavstalkrouter = function(x,y){
	if (y===2){
		...
		if (userInfo.gold<25){
			...
			output(2, "Looking around to be sure he's not overheard, Dean leans in close to you again. <span id=quote>I heard that " + target + " is camping just outside of town tonight. Not far from the Graveyard. But... you never heard that from me.</span><br>");
			output(3, "<span id=menu>Press <span id=letter>Any</span> key to thank Dean and discreetly slip out of the tavern, or <span id=letter>N</span> to forget it and return to your swill.</span>");
			thread=8.3;
			userInfo.gold -= 25;
			statusupdate();
