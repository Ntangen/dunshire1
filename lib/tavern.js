...
deantalk = function(){
	if (userInfo.level===0){
		...
		output(3, "If you hope to reach the level of Apprentice, you'll have to arm yourself with something powerful. You should go see the Smithy about that.<br>");
...
minstrel = function(x){
	...
	if (x==="a"){
		...
		if (findgems()){
			...
			output(3, "\"Why, dear Patron, you honor me. Allow me to sing this ballad in your honor!\"" + 
...
findgems = function(){
	...
	for (i=0; i=userInfo.items.other.length-1;i++){
