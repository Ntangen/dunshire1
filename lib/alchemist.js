...
alchemyrouter = function(x,y){
	if (x==="h"){
		...
		if (y==="n") {
			// decline the quest
			clear();
			output(1, "Morgan shrugs. <span id=quote>\"Suit yourself... maybe another time.\"</span><br><br>");
			setTimeout(function(){ alchemist() }, 1500);
			thread = 0.905;
		} else {
			clear();
			...
			output(3, "Morgan draws you a crude map of the eastern quarter of the Dark Woods. You'll begin your search there.<br><br>");
