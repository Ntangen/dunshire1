		...
		if (ghost.length=1){
			...
			if (ghost[0].result==="w"){
				...
				Meteor.call("userduel",userInfo.username,x,"notify", function(err,res){
					...
					console.log("result: " + res);
					ghost=undefined;
					return "<span id=defeat>You were attacked in the night by " + ghost[0].opp + ", and they defeated you, looting you of some gold!</span><br>You shall remember this transgression...";
				});
			}
		} else {
			var temp="";
