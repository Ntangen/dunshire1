...
magerouter = function(x){
	if (x==="q"){
		...
		output(2, "<span id=quote>As your mind becomes stronger, and you gain Mysticism points, I can teach you new curses to lance upon your enemies - or yourself. Each lesson will cost you in gold, <b>plus one precious gem.</span></b><br>" +
			"<span id=quote>Here's what you I'm willing to share with you for now...<br></span>");
