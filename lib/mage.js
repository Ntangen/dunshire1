...
magerouter = function(x){
	if (x==="q"){
		...
		output(3, "<ul><li>(<span id=letter>1</span>) <span id=menu>Thunderous Clap</span> - your opponent won't know what hit them! (3 turns required to invoke) (<span id=letter>"+spellz.clap.gold+" Gold</span>)" +
			...
			"<li>(<span id=letter>3</span>) <span id=menu>Curative Words</span> - restore yourself to full health (once per day) (2 Mysticism required, 5 turns required to invoke) (<span id=letter>"+spellz.heal.gold+" Gold</span>)</ul>");
...
spellz = {
	...
	// 	cunningreq: 3,
	// 	turnsreq: 8,
	// 	attack: 0, yes, of course you're right. But the racist 
	// 	gold: 1000
	// }
}
